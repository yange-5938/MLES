...
int main(void) {
	...
	linear_backward(NUM_OF_HID1_NODES,NUM_OF_FEATURES,1,dZ1,raw_x,dW1,db1[0]);

	/*UPDATE PARAMETERS*/

	printf("before updated dW1 \n");
	matrix_print(NUM_OF_FEATURES,NUM_OF_HID1_NODES, dW1);
	
	printf("before updated W1 \n");
	matrix_print(NUM_OF_FEATURES, NUM_OF_HID1_NODES, w1);
	...
	// printf("before updated b1 \n");
	// matrix_print(1, NUM_OF_HID1_NODES, b1);

	// printf("before updated db1 \n");
	// matrix_print(1, NUM_OF_HID1_NODES, db1);

	weights_update(1,NUM_OF_HID1_NODES,learning_rate,db1,b1);
	...
	weights_update(1,1,learning_rate,db2,b2);
